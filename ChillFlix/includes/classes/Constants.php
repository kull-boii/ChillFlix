...
// Generalizing all the error messages to avoid any ambiguity

class Constants {

    // making it as public static so we can call it without creating object as show in Accounts.php
