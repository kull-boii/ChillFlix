...
class EntityProvider {
    public static function getEntities($con, $categoryId, $limit) {
        ...
        $sql = "SELECT * FROM entities "; // Get's all the entities

        if($categoryId != null) {
            $sql .= "WHERE categoryId=:categoryId ";
        }

        $sql .= "ORDER BY RAND() LIMIT :limit"; // Order entities by random, based on the limit provided
        ...
        $query->bindValue(":limit", $limit, PDO::PARAM_INT); // Using php data object
    ...
    public static function getSearchEntities($con, $term) {
        ...
        $query->bindValue(":term", $term); // Using php data object
